...
let comLvl = 0.1 // oyunun zorluk derecesi 1 e yaklaşınca zorlaşıyor
com.y += (ball.y - (com.y + com.h/2)) * comLvl

let player = (ball.x < cvs.width/2) ? user : com
if(collisiton(ball,player)){
...
drawRect(0,0,cvs.width,cvs.height, '#008374')// Halı saha rengi
